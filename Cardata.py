    ...
    try:
       ...
       for key, value in final_data_to_insert.items():
            if value == '(adsbygoogle = window.adsbygoogle || []).push({});':
                ...
                break
       for key, value in final_data_to_insert.items():
            if value == 'Performance specs':
                final_data_to_insert.pop(key)
                break
       for key, value in final_data_to_insert.items():
            if value == 'Engine oil specification':
                final_data_to_insert.pop(key)
                break
       for key, value in final_data_to_insert.items():
            if value == 'Dimensions':
                ...
                break
       for key, value in final_data_to_insert.items():
            if value == 'Space, Volume and weights':
                final_data_to_insert.pop(key)
                break 
       for key, value in final_data_to_insert.items():
            if value == 'Drivetrain, brakes and suspension specs':
                final_data_to_insert.pop(key)
                break  
       ...
       return jsonify("Data Inserted Successfully")
        ...
        print("Exception in inserting data : ",(str(ex)))
        print(traceback.print_exc())
        return jsonify("Exception in inserting data.")
